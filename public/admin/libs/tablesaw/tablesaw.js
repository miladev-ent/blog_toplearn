...
var Tablesaw = {
	i18n: {
		modeStack: "پشته",
		modeSwipe: "سوایپ",
		modeToggle: "تغییر وضعیت",
		modeSwitchColumnsAbbreviated: "ستون ها",
		modeSwitchColumns: "ستون ها",
		columnToggleButton: "ستون ها",
		columnToggleError: "ستونی یافت نشد.",
		sort: "مرتب سازی",
		swipePreviousColumn: "ستون قبلی",
		swipeNextColumn: "ستون بعدی"
	},
	// cut the mustard
	mustard:
